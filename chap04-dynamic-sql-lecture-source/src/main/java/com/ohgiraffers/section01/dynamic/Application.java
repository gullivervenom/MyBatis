...
public class Application {
    ...
    private static void trimSubMenu() {
        ...
        do{
            ...
            System.out.println("2. 메뉴 혹은 카테고리 코드로 검색, 메뉴와 카테고리 둘 다 일치하는 경우도 검색, 검색 조건 없으면 전체 조회");
    ...
    private static void foreachSubMenu() {
        ...
        do{
            ...
            switch(no){
                case 1:
                    menuService.searchMenuByRandomCode(creatRandomCodeList()); break;
                case 9:
                    return;
